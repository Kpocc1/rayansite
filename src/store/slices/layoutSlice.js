	...
	reducers: {
		...
		setYookassaWidgetData: (state, { payload }) => {
			setCustomer({
				...
				last_order_id: payload.lastOrderId,
			});
		...
		setCityConfirmModalIsOpen: (state, { payload }) => {
			state.cityConfirmModalIsOpen =
				payload !== undefined ? payload : !state.cityConfirmModalIsOpen;
		},
	},
